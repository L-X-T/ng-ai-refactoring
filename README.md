# NG AI Refactoring verstaubter Angular-Komponenten mithilfe von KI
...
Findest Du auf [LXT.dev](https://lxt.dev), genauer gesagt hier: https://lxt.dev/ng-ai-refactoring.pdf.
